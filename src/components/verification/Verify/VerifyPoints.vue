...
<script type="text/babel">
  ...
  import { onMounted, reactive, ref, watch, nextTick, toRefs, watchEffect, getCurrentInstance } from 'vue';
              ...
              body: JSON.stringify(data),
                ...
                .then((resp) => {
                  if (resp.repCode === '0000') {
                    ...
                    text.value = t('invite.verifySuccess');
                    ...
                    text.value = t('invite.verifyFailure');
                    setTimeout(() => {
                      refresh();
                    }, 700);
                  }
      ...
      function getPictrue() {
        ...
        fetch(`${API_URL}/captcha/get`, {
          ...
          body: JSON.stringify(data),
            ...
            .then((resp) => {
              if (resp.repCode === '0000') {
                pointBackImgBase.value = resp.repData.originalImageBase64;
                // blockBackImgBase.value = resp.repData.jigsawImageBase64;
                backToken.value = resp.repData.token;
                secretKey.value = resp.repData.secretKey;
                poinTextList.value = resp.repData.wordList;
                text.value = `${t('invite.touchWord')}【` + poinTextList.value.join(',') + '】';
              } else {
            ...
            .catch((err) => {
              console.error(err);
              tipWords.value = t('invite.networkErrorå');
            });
      }
      //坐标转换函数
